...
namespace CHDKPTP
{
    ...
    public static class CHDKPTPUtil
    {
        ...
        public static List<CHDKPTPDevice> FindDevices(
            bool only_supported = true,
            Func<UsbDevice, CHDKPTPDevice> constr = null)
        {
            if (constr == null)
            {
            ...
            var r = PTPUtil.FindDevices(only_supported, constr).ConvertAll(CheckSupported);
